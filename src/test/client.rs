...
use crate::api::{error::ApiError, AsyncClient, Client, RestClient};
...
impl ExpectedUrl {
    ...
    fn check(&self, method: Method, url: &Url) {
        ...
        assert_eq!(url.host_str().unwrap(), "api.teamdeck.host.invalid");
...
const CLIENT_STUB: &str = "https://api.teamdeck.host.invalid/v1";
